...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-sidebar flex flex-col z-50 border-r border-white/10">
      {/* Brand */}
      <div className="flex items-center h-20 px-6 border-b border-white/6">
        <img src="/logos/Isologo-White.svg" alt="TEKO" className="h-7 w-auto" />
      </div>
      ...
      {/* Bottom */}
      <div className="px-3 pb-5 pt-2 border-t border-white/6">
        <Link
          href="/settings"
          className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium transition-colors ${
